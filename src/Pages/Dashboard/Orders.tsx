...
import Add_Order_dialog from "../../Components/Dialogs/Add_order";
import orderimage from "../../assets/images/png/order_help.png"
...
const Orders = () => {
    ...
    return (
        <div style={{margin:"50px 5px 5px 5px",display:"flex"}}>
            <div style={{width:"75%"}}>
                <Paper style={{borderRadius:"15px"}} elevation={1} className={classes.top4carts}>
            ...
            <div style={{width:"25%",backgroundColor:"#13003e",borderRadius:"15px",margin:"1% 15px 15px 15px",height:"fit-content"}}>
                <img style={{width:"100%",marginTop:"-40px"}} src={orderimage} alt=""/>

                <Typography style={{color:"#fffeff",fontWeight:"bolder",fontSize:"20px",marginRight:"16px",marginLeft:"16px",marginTop:"20px"}}>What is order? </Typography>
