...
function getSteps() {
    return ['Company information', 'Company detail ', 'Description','Address','Logo','Finish'];
}
            ...
            case 0:
                return <>
                    <div className={classes.halfdiv}>
                        <TextField className={classes.textboxstyle} id="outlined-basic" label="Name in English" variant="outlined" />
                        <TextField className={classes.textboxstyle} id="outlined-basic" label="Name in Arabic" variant="outlined" />
                    </div>

                    <div className={classes.halfdiv}>
                        <TextField className={classes.textboxstyle} id="outlined-basic" label="Phone" variant="outlined" />
                        <TextField className={classes.textboxstyle} id="outlined-basic" label="Email" variant="outlined" />
                    </div>
                ...
                return <>
                    ...
                    <div className={classes.halfdiv}>
                        <div style={{display:"flex"}} className={classes.halfdiv}>
                            <TextField className={classes.textboxstyle} id="outlined-basic" label="Website" variant="outlined" />
                            <Autocomplete
