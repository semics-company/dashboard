...
function getSteps() {
    return ['Advert detail', 'Description','Advert type','Upload','Finish'];
}
...
export default function Add_advert_steper() {
    ...
    const [checkboxvalue,setcheckboxvalue]=useState("Video");
    ...
    const [{altvid1, srcvid1}, setvid] = useState({
        srcvid1: "placeholder",
        altvid1: 'Upload an Image'
    });
    ...
    const handleVideo = (e:any) => {
        ...
        setTimeout(()=>{
            if(e.target.files[0]) {
                ...
                setvid({
                    srcvid1: URL.createObjectURL(e.target.files[0]),
                    altvid1: e.target.files[0].name
                });
            }
        },2000)
        ...
        switch (step) {
            case 0:
                return <>
                    <div className={classes.halfdiv}>
                        <TextField className={classes.textboxstyle} id="outlined-basic" label="Title in English" variant="outlined" />
                        <TextField className={classes.textboxstyle} id="outlined-basic" label="Title in Arabic" variant="outlined" />
                    </div>
                                    ...
                                    <FormControlLabel
                                        control={
                                            <Checkbox
                                                name="checkedB"
                                                color="secondary"
                                                onClick={e=> changetypeadvert("Image")}
                                                checked={checkboxvalue=="Image" && true}

                                            />
                                        }
                                        label="Advert by image"
                                    />
                                </CardContent>
                            </div>
                            <CardMedia
                                    ...
                                    <FormControlLabel
                                        control={
                                            <Checkbox
                                                name="checkedB"
                                                color="secondary"
                                                onClick={e=> changetypeadvert("Video")}
                                                checked={checkboxvalue=="Video" && true}

                                            />
                                        }
                                        label="Advert by video"
                                    />
                                </CardContent>
            ...
            case 3:
                return <div style={{display:"flex",justifyContent:"center",alignItems:"center"}}>
                    ...
                    {checkboxvalue=="Video"? <>
                        <div style={{height:"200px",width:"200px",borderRadius:"50%"}}>
                            <input onChange={handleVideo} style={{display:"none"}} id="icon-button-file2" type="file" />
                            <label htmlFor="icon-button-file2">
                                <Avatar style={{width:"200px",height:"200px",cursor:"pointer"}} >
                                    {video?<>
                                            <div>
                                                <CircularProgress color={"secondary"} style={videoloading?{display:"block"}:{display:"none"}} size={210} className={classes.fabProgress} />

                                            </div>
                                            <div style={{width:"200px",height:"200px",backgroundColor:"#fb6761",display:"flex",justifyContent:"center",alignItems:"center"}}>
                                                <CheckIcon style={{width:"70px",height:"70px"}}/>
                                            </div>
                                        ...
                                        :<>
                                            ...
                                            <div style={{display:"flex",flexDirection:"column",justifyContent:"center",alignItems:"center"}}>
                                                <BackupIcon style={{width:"70px",height:"70px"}} />
                                                <small style={{fontSize:"14px"}}>Upload Video</small>
                                            </div>
                                        </>
                        ...
                        <div style={{height:"200px",width:"200px",borderRadius:"50%"}}>
                            <input accept="image/*" onChange={handleImg} style={{display:"none"}} id="icon-button-file" type="file" />
                            <label htmlFor="icon-button-file">
                                <Avatar style={{width:"200px",height:"200px",cursor:"pointer"}} >
                                    {image?<>
                                            <div>
                                                <CircularProgress color={"secondary"} style={imageloading?{display:"block"}:{display:"none"}} size={210} className={classes.fabProgress} />

                                            </div>
                                            <img className={classes.fullwitdh} src={src}/>
                                        ...
                                        :<>
                                            ...
                                            <div style={{display:"flex",flexDirection:"column",justifyContent:"center",alignItems:"center"}}>
                                                <BackupIcon style={{width:"70px",height:"70px"}} />
                                                <small style={{fontSize:"14px"}}>Upload logo</small>
