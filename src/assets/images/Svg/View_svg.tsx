...
const ViewSvg = () => {
    return (
        ...
        >
            <defs>
                <clipPath id="freepik--clip-path--inject-187">
                    <rect
                        x="155.14"
                        y="85.59"
                        width="189.09"
                ...
                <clipPath id="freepik--clip-path-2--inject-187">
                    <path
                        d="M438.67,153.27H237.31V213a76.14,76.14,0,1,0,70.75,121H438.67Z"
                        style={{ fill: "none" }}
                    />
                </clipPath>
                <clipPath id="freepik--clip-path-3--inject-187">
                    <path
                ...
                <clipPath id="freepik--clip-path-4--inject-187">
                    <path
                ...
                <clipPath id="freepik--clip-path-5--inject-187">
                    <path
                ...
                <clipPath id="freepik--clip-path-6--inject-187">
                    <path
                ...
                <clipPath id="freepik--clip-path-7--inject-187">
                    <path
                ...
                <clipPath id="freepik--clip-path-8--inject-187">
                    <path
            ...
            <g id="freepik--Device--inject-187">
                <rect
                    x="155.14"
                    y="85.59"
                    width="189.09"
                    ...
                    style={{ fill: "#263238" }}
                />
                <g style={{ clipPath: "url(#freepik--clip-path--inject-187)" }}>
                    <path
            ...
            <g id="freepik--Character--inject-187">
                <g style={{ clipPath: "url(#freepik--clip-path-2--inject-187)" }}>
                    <path
                        d="M164,363s21.08-73.4,25.06-89.09,10-25.9,22.42-28.39,35.35-4.8,35.35-4.8,19.93-2,34.37-1,27.65,8.72,34.62,14,27.15,23.41,27.15,23.41l-2.49-41.84,18.18,1.49s13.2,58.28,14.94,69,1.75,15.45,0,16.69,1.25,2-14.69-3.24-34.62-12.45-44.83-15.44-11.46-3.49-11.46-3.49-25,37.62-32.95,48.83a193.42,193.42,0,0,0-14.52,25"
                        style={{ fill: "#fff" }}
                    />
                    <g style={{ clipPath: "url(#freepik--clip-path-3--inject-187)" }}>
                        <path
                    ...
                    <path
                        ...
                        style={{ fill: "#fff" }}
                    />
                    <g style={{ clipPath: "url(#freepik--clip-path-4--inject-187)" }}>
                        <path
                    ...
                    <path
                        ...
                        style={{ fill: "#fff" }}
                    />
                    <g style={{ clipPath: "url(#freepik--clip-path-5--inject-187)" }}>
                        <path
                    ...
                    <path
                        ...
                        style={{ fill: "#263238" }}
                    />
                    <g style={{ clipPath: "url(#freepik--clip-path-6--inject-187)" }}>
                        <path
                    ...
                    <path
                        ...
                        style={{ fill: "#fff" }}
                    />
                    <g style={{ clipPath: "url(#freepik--clip-path-7--inject-187)" }}>
                        <path
                    ...
                    <path
                        ...
                        style={{ fill: "#fff" }}
                    />
                    <g style={{ clipPath: "url(#freepik--clip-path-8--inject-187)" }}>
                        <path
                            d="M322.85,271.07a7.77,7.77,0,0,0,1.15-3c.22-1,0,0,1-.77s1.09-5.27,1.09-5.27,1.24-.29,3.42-2.35,2.61-4.31.8-6.25-14.11-5.3-17.56-4c-.9.35-2,1.6-3.2,3.48,1.83,3,4,4.83,2,10.07-3,8-10,18-16,26.5s-56,55.5-62,54.5c-4.9-.82-19.13-18-24.19-24.23,10.84,17.39,23.24,35.76,26.39,35.67,5.23-.16,38.69-30.58,49.25-43.86S306.8,276,308.53,275.74a58.62,58.62,0,0,0,8.18-1.5,22.92,22.92,0,0,0,4.45-1.38C321.9,272.59,322.13,272.09,322.85,271.07Z"
                            style={{ opacity: "0.2" }}
                        />
